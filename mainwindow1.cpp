    ...
    ui(new Ui::MainWindow1)
{
    ...
    connect(ui->pushButton_10,SIGNAL(released()),this,SLOT(digit_pressed()));
    connect(ui->pushButton_11,SIGNAL(released()),this,SLOT(digit_pressed()));
...
void MainWindow1::digit_pressed()
{
   // qDebug() << "test";
...
void MainWindow1::unary_operation_pressed()
{
    QPushButton* button = (QPushButton *)sender();
    double labelnumber;
    QString input;
...
void MainWindow1::on_pushButton_clear_released()
{
...
void MainWindow1::on_pushButton_equals_released()
{
...
void MainWindow1::binary_operation_pressed()
{
    QPushButton* button = (QPushButton *)sender();
    //double labelnumber;
    //QString input;
